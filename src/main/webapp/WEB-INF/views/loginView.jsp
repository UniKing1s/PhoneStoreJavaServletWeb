                ...
                <div class="card p-4">
                    ...
                    <div class="input-group mb-4">
                        <!--Grid column-->
                            <!--firstName-->
                            <div class="form-outline">
                                <input type="text" name="password" id="typeText" class="form-control" />
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-md-6 mb-2">
                        <!--firstName-->
                            <a href="register" class="border rounded px-2 nav-link" style=" background-color: #3b71ca ; text-align: center;" target="_blank"><font style="color: white;"><b>Đăng ký</b></font></a>
                    </div>
                    <div class="col-md-6 mb-2">
                        <!--firstName-->
